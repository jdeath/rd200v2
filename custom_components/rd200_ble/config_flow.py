    ...
    async def async_step_user(
        ...
        for discovery_info in async_discovered_service_info(self.hass):
            ...
            if not (
                ...
                or discovery_info.advertisement.local_name.startswith("FR:HB")
                ...
                or discovery_info.advertisement.local_name.startswith("FR:HE")
                or discovery_info.advertisement.local_name.startswith("FR:HD")
                or discovery_info.advertisement.local_name.startswith("FR:HF")
                or discovery_info.advertisement.local_name.startswith("FR:HG")
                or discovery_info.advertisement.local_name.startswith("FR:HJ")
                or discovery_info.advertisement.local_name.startswith("FR:HK")
                or discovery_info.advertisement.local_name.startswith("FR:HL")
                ...
                or discovery_info.advertisement.local_name.startswith("FR:IA")
            ):
                continue
